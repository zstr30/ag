...
echo "| Simpel script by Zstr \n";
echo "| Wa 081215854701 \n";
echo "| --------------------------- \n";
if(file_exists("config.json")){
    ...
    $memberid = $arr2['id'];
    $hp = $arr2['hp'];
    echo "| we wes tau login nganggo nomer iki cok $hp \n";
    echo "| 1. Login \n";
    echo "| 2. Daftar \n";
    echo "| Pilih: ";
